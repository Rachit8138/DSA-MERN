public class a1 {
    ...
    public static void main(String[] args) {
        ...
        //  System.out.println(sum_n(5));        // sum of n numbers
         System.out.println(fib(6));        // fibonacci nth term
        
        
        // int arr[]={8,3,5,9,5,10,2,5,3};
        // System.out.println(first_occ(arr, 5, 0));         //find first occurence
        // System.out.println(last_occ(arr, 7, arr.length-1));  //find last occurence
